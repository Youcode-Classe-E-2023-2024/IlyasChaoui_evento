...
<head>
    ...
    <!-- cards -->
    <link rel="stylesheet" href="{{ asset('./assets-dashboard/css/cards.css') }}">
    ...
    <link href="{{ asset('./assets-dashboard/css/button.css') }}" rel="stylesheet" />
    <!-- Main Styling -->
    <link href="{{ asset('./assets-dashboard/css/argon-dashboard-tailwind.css?v=1.0.1') }}" rel="stylesheet" />
    <!-- Font Awesome Icons -->
...
<body
    ...
    <div
        class="absolute bg-y-50 w-full top-0 bg-[url('https://raw.githubusercontent.com/creativetimofficial/public-assets-dashboard/master/argon-dashboard-pro/assets-dashboard/img/profile-layout-header.jpg')] min-h-75">
...
<script src="{{ asset('./assets-dashboard/js/role.js') }}"></script>
