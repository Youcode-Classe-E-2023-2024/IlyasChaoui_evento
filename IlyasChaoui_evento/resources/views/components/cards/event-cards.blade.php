                        ...
                        <div class="bg-white dark:bg-gray-800 shadow-xl rounded-lg overflow-hidden">
                            ...
                            <div class="p-4">
                                <div class="flex justify-between">
                                    <p class="uppercase bg-gray-200 dark:bg-gray-500 rounded-xl tracking-wide p-3 text-sm font-bold text-gray-700 dark:text-white"
                                ...
                                <p class="text-3xl mt-5 mb-5 text-gray-900 dark:text-white">
                                    {{ substr($event->title, 0, 17) }}</p>
                                <div class="flex space-x-1 items-center">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="h-6 w-6 dark:text-white text-black mb-1.5" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                    </span>
                                    <div class="countdown-timer text-black dark:text-white"
                                        data-deadline="{{ $event->deadline }}">
                                    </div>
                                </div>
                            </div>
                            <div class="flex flex-col p-4 border-t border-gray-300 text-gray-700 dark:text-white">
                                <div class="flex-1 inline-flex items-center">
                                    <svg class="h-6 w-6 text-gray-600 dark:text-white fill-current mr-3"
                                    ...
                                    <p><span
                                            class="text-gray-900 dark:text-white font-bold">({{ $event->reservationsCount->count() }}/{{ $event->place_number }})</span>
                                        Places</p>
                                </div>
                                <div class="flex-1 inline-flex items-center">
                                    <svg class="h-6 w-6 text-gray-600 dark:text-white fill-current mr-3"
                            ...
                            <div class="px-4 pt-3 pb-4 border-t border-gray-300 bg-gray-100 dark:bg-gray-700">
                                <div class="text-xs uppercase font-bold dark:text-white text-gray-600 tracking-wide">
                                    Realtor</div>
                                <div class="flex justify-between items-center pt-2">
                                    <div class="rounded-full text-black mr-3">
                                        <span class="font-light dark:text-white">Start with:</span> <br> <span
                                            class="font-bold dark:text-white text-2xl">{{ $event->price }}$</span>
                                    </div>
                                    <div>
                                        <a href="{{ route('content.page', ['id' => $event->id, 'categoryId' => $event->category->id]) }}"
