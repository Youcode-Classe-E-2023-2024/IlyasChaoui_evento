            ...
            <div class="content max-w-sm w-full sm:w-full lg:w-full py-6 px-3">
                <div class="bg-white dark:bg-slate-850 shadow-xl rounded-lg overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <p class="text-3xl text-gray-900">{{ $event->title }}</p>
                        <div class="flex space-x-1 items-center">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-black dark:text-white mb-1.5"
                    ...
                    <div class="flex justify-between">
                        <div class="flex flex-col p-4 border-t border-gray-300 text-gray-700">
                            <div class="flex-1 inline-flex items-center">
                                ...
                                <p><span class="text-gray-900 font-bold">({{ $event->reservations->count() }}/{{ $event->place_number }})</span>
                                    Places</p>
                            </div>
                            <div class="flex-1 inline-flex items-center">
                                <svg class="h-6 w-6 text-gray-600 fill-current mr-3"
                        ...
                        <div class="mr-10 mt-4">
                            <div class="flex">
                                <x-popup.popup-edit-event :event="$event" :user="$user" :cities="$cities" :categories="$categories"/>
                                <form action="{{ route('delete.event', ['id'=> $event->id]) }}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="bntDelete ml-2">
                                        <svg class="svg" viewBox="0 0 448 512">
                                            <path fill="currentColor"
                                                  d="M313.6 256l134.4-134.4c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 210.4 121.6 76C109.1 63.5 88.8 63.5 76.3 76s-12.5 32.8 0 45.3L210.4 256 76 390.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L256 301.6l134.4 134.4c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.6 256z"></path>
                                        </svg>
                                    </button>
                                </form>
                            </div>
                    ...
                    <div class="px-4 pt-3 pb-4 border-t border-gray-300 bg-gray-100">
                        ...
                        <div class="flex justify-between items-center pt-2">
                            ...
                            <div>
                                <a href="{{ route('static.content.page', ['id' => $event->id, 'categoryId' => $event->category->id]) }}"
