<footer class="wow fadeInUp relative z-10 bg-[#090E34] pt-20 lg:pt-[100px]" data-wow-delay=".15s">
                    ...
                    <div class="flex flex-col gap-8">
                        <a href="blog-details.html" class="group flex items-center gap-[22px]">
                            <div class="overflow-hidden rounded">
                                <img src="{{ asset('./assets-home/images/blog/blog-footer-01.jpg') }}" alt="blog" />
                            </div>
                        ...
                        <a href="blog-details.html" class="group flex items-center gap-[22px]">
                            <div class="overflow-hidden rounded">
                                <img src="{{ asset('./assets-home/images/blog/blog-footer-02.jpg') }}" alt="blog" />
                            </div>
                            <span class="max-w-[180px] text-base text-gray-7 group-hover:text-white">
                ...
                <div class="w-full px-4 md:w-1/3 lg:w-1/2">
                    <div class="my-1 flex justify-center md:justify-end">
                        <p class="text-base text-gray-7">
                            Designed and Developed by <br> Full-Stack developper
    ...
    <div>
        <span class="absolute left-0 top-0 z-[-1]">
            <img src="{{ asset('assets-home/images/footer/shape-1.svg') }}" alt="" />
        </span>

        <span class="absolute bottom-0 right-0 z-[-1]">
            <img src="{{ asset('assets-home/images/footer/shape-3.svg') }}" alt="" />
        </span>
