                ...
                <div
                    ...
                    <form action="{{ route('store.user') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="mb-[22px] ml-5">
                                <div class="mb-[22px] ml-4">
                                    <select name="city_id" class=" px-5 py-3 text-base transition bg-transparent border rounded-md outline-none border-stroke dark:border-dark-3 text-body-color dark:text-dark-6 placeholder:text-dark-6 focus:border-primary dark:focus:border-primary focus-visible:shadow-none" style="width: 190px" >
                        ...
                        <div class="flex justify-between">
                            <div class="mb-[22px]">
                                <input type="text" placeholder="Phone Number" name="phoneNumber" value="{{ old('phoneNumber') }}"
                                       class="px-5 py-3 text-base transition bg-transparent border rounded-md outline-none border-stroke dark:border-dark-3 text-body-color dark:text-dark-6 placeholder:text-dark-6 focus:border-primary dark:focus:border-primary focus-visible:shadow-none" style="width: 190px" />
                            </div>
                            <div class="mb-[22px] ml-4">
                                <select name="role" class=" px-5 py-3 text-base transition bg-transparent border rounded-md outline-none border-stroke dark:border-dark-3 text-body-color dark:text-dark-6 placeholder:text-dark-6 focus:border-primary dark:focus:border-primary focus-visible:shadow-none" style="width: 190px" >
