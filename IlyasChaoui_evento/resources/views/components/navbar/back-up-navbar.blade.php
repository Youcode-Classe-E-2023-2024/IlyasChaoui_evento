                    ...
                    <nav id="navbarCollapse"
                        ...
                        <ul class="block lg:flex 2xl:ml-20">
                            <li class="group relative">
                                <a href="/"
                                    class="ud-menu-scroll mx-8 flex py-2 text-base font-medium text-dark dark:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:group-hover:opacity-70">
                                    Home
                                </a>
                            </li>
                            <li class="group relative">
                                <a href="#contact"
                                    class="ud-menu-scroll mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:ml-7 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6  lg:group-hover:opacity-70 xl:ml-10">
                                    Contact
                                </a>
                            </li>
                            <li class="group relative">
                                <select id="categorySelect" onchange="redirectToCategory(this)"
                                    class="mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white bg-transparent lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:group-hover:text-dark lg:group-hover:opacity-70">
                            ...
                            <li class="group relative">
                                <a href="javascript:void(0)"
                                    class="ud-menu-scroll mx-8 flex py-2 text-base font-medium text-dark group-hover:text-dark
                                    dark:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:group-hover:text-white ">
                                    Cities
                                ...
                                <div
                                    class="submenu overflow-y-auto relative left-0 top-full hidden w-[250px] rounded-sm bg-white p-4 transition-[top] duration-300 group-hover:opacity-100 dark:bg-dark-2 lg:invisible lg:absolute lg:top-[110%] lg:block lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full">
                                    @foreach ($cities as $city)
                                        <a class="block rounded px-4 py-[10px] text-sm text-body-color hover:text-primary dark:text-dark-6 dark:hover:text-primary"
                ...
                <div class="flex items-center justify-end pr-16 lg:pr-0">
                    ...
                    <div class="hidden sm:flex">
                        @guest
                            ...
                            <a href="/register"
                                class="px-6 py-2 text-base font-medium text-white duration-300 ease-in-out rounded-md signUpBtn hover:bg-blue-dark"
                                style="background-color:#4B1B2F ">
                                Sign Up
                            </a>
                        @endguest
                        <!-- component -->
                                ...
                                <div @click="open = !open" class="relative border-b-4 border-transparent py-3"
                                    ...
                                    <div class="flex justify-center pl-2 pt-1 items-center space-x-3 cursor-pointer">
                                        <div
                                            ...
                                            <img src="{{ asset($user->picture) }}" alt="profileImage"
