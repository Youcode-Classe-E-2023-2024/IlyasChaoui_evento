<nav class="relative flex flex-wrap @if (Request::url() === 'http://127.0.0.1:8000/template') bg-blue-500 @endif items-center justify-between px-0 py-2 mx-6 transition-all ease-in shadow-none duration-250 rounded-2xl lg:flex-nowrap lg:justify-start"
        ...
        <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
            ...
            <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                ...
                <form action="{{ route('logout') }}" method="post">
                    @csrf
                    <li class="flex items-center">
                        <div class="block px-0 py-2 text-sm font-semibold text-white transition-all ease-nav-brand">
                            <i class="fa fa-user sm:mr-1"></i>
                            <button type="submit" class="hidden sm:inline">Log out</button>
                        </div>
                    </li>
                </form>
