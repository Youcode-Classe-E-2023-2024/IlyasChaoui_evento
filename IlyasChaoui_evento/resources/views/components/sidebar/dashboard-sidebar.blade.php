    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full" style="height: 80%">
        <ul class="flex flex-col pl-0 mb-0">
            <li class="mt-0.5 w-full">
                <a class="py-2.7 @if (Request::url() === 'http://127.0.0.1:8000/dashboard') bg-blue-500/13 @endif  dark:text-white dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors"
                    href="/dashboard">
                    <div
            ...
            <li class="mt-0.5 w-full">
                <a class=" dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Medias</span>
                </a>
            </li>
