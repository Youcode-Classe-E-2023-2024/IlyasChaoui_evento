...
@section('content')
    ...
    <section class="pb-10 dark:bg-dark lg:pb-20">
        <div class="container">
                ...
                <div class="w-full px-4">
                    <div class="wow fadeInUp relative z-20 mb-[50px] h-[300px] overflow-hidden rounded-[5px] md:h-[400px] lg:h-[500px]"
                        ...
                        @foreach ($event->getMedia() as $mediaItem)
                            <img class="object-cover object-center w-full h-full rounded-xl"
                                src="{{ $mediaItem->getUrl() }}" alt="Colors" />
                        @endforeach
                        <div
                            ...
                            <div class="flex flex-wrap items-center p-4 pb-4 sm:px-8">
                                <div class="flex items-center mb-4 mr-5 md:mr-10">
                                    <div class="w-10 h-10 mr-4 overflow-hidden rounded-full">
                                        <img src="./assets-home/images/blog/author-01.png" alt="image" class="w-full" />
                                    </div>
                    ...
                    <div class="flex flex-wrap -mx-4">
                        <div class="w-full px-4 lg:w-8/12">
                            <div>
                                <p class="mb-8 text-base wow fadeInUp text-body-color dark:text-dark-6"
                                    data-wow-delay=".1s">
                                    {{ $event->description }}
                                </p>
                    ...
                    ">
                                    ...
                                    <div>
                                        <span class="absolute top-0 left-0">
                                            <svg width="103" height="109" viewBox="0 0 103 109" fill="none"
                                                ...
                                                <defs>
                                                    <linearGradient id="paint0_linear_2014_9016" x1="-101.591"
                                                        y1="-50.4346" x2="49.1618" y2="-49.6518"
                        ...
                        <div class="w-full px-4 lg:w-4/12">
                            <div>
                                <div class="wow fadeInUp relative mb-12 overflow-hidden rounded-[5px] px-11 py-[60px] text-center lg:px-8"
                                    style="background-color:#4B1B2F " data-wow-delay=".1s">

                                    <p class="flex items-center mr-5 text-sm font-medium text-white md:mr-6">
                                    <h3 class="mb-[6px] text-xl font-semibold leading-[40px] text-white">
                                        {{ \Carbon\Carbon::parse($event->deadline)->locale('fr')->isoFormat('dddd D MMMM YYYY') }}
                                    </h3>

                                    </p>
                                    <h3 class="mb-[6px] text-xl font-normal leading-[40px] text-white">
                                        {{ $event->city->City }}
                                    </h3>
                                    <h3 class="mb-[6px] text-md font-light leading-[40px] text-white">
                                        Ouverture des portes à 21:30
                                    </h3>
                                    ...
                                    <div class="countdown-timer mb-10" data-deadline="{{ $event->deadline }}">
                                        <div class="flex flex-col">
                                            <div class="circle" id="days-circle"></div>
                                            <div class="countdown-label" id="days-label"></div>
                                        </div>
                                        <div class="flex flex-col">
                                            <div class="circle" id="hours-circle"></div>
                                            <div class="countdown-label" id="hours-label"></div>
                                        </div>

                                        <div class="flex flex-col">
                                            <div class="circle" id="minutes-circle"></div>
                                            <div class="countdown-label" id="minutes-label"></div>
                                        </div>
                                        <div class="flex flex-col">

                                            <div class="circle" id="seconds-circle"></div>
                                            <div class="countdown-label" id="seconds-label"></div>
                                        </div>
                                    </div>

                                    <p class="text-sm mt-10 font-medium text-white">
                                    ...
                                    @foreach ($popularEvents as $event)
                                        <div class="w-full px-4 md:w-1/2 lg:w-full">
                                            <div class="flex items-center w-full pb-5 mb-5 border-b wow fadeInUp border-stroke dark:border-dark-3"
                                                data-wow-delay=".1s">
                                                <div class="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-xl">
                                                    @foreach ($event->getMedia() as $mediaItem)
                                                        <img class="w-full rounded-sm" src="{{ $mediaItem->getUrl() }}"
                                                            alt="Colors" />
                                                    @endforeach
                                                </div>
                                                <div class="w-full">
                ...
                @foreach ($relatedEvents as $event)
                    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                        <div class="mb-10 wow fadeInUp group" data-wow-delay=".1s">
                            <div class="mb-8 overflow-hidden h-56 rounded-[5px]">
                                <a href="{{ route('content.page', ['id' => $event->id, 'categoryId' => $event->category->id]) }}"
                                    class="block">
                                    @foreach ($event->getMedia() as $mediaItem)
                                        <img class="w-full rounded-sm" src="{{ $mediaItem->getUrl() }}"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            countdownElements.forEach(element => {
                ...
                const interval = setInterval(() => {
                    ...
                    daysCircle.innerHTML = days;
                    hoursCircle.innerHTML = hours;
                    minutesCircle.innerHTML = minutes;
                    secondsCircle.innerHTML = seconds;
